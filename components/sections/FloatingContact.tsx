    ...
    <div className="fixed bottom-[13px] right-[11px] z-50 rounded-full bg-muted-bg p-[7px] float-shadow">
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:-translate-y-0.5"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/90 text-primary-foreground shadow-lg transition-transform hover:-translate-y-0.5"
