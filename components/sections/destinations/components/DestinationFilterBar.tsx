      ...
      {filters.map((filter) => {
        ...
        return (
          <button
            ...
            className={cn(
              'inline-flex min-w-37.5 cursor-pointer items-center justify-center rounded-[14px] px-8 py-3.5 text-[15px] font-bold text-white shadow-[0_10px_22px_rgba(15,23,42,0.18)] transition-all duration-200 hover:-translate-y-0.5 md:min-w-45 md:px-10 md:py-4 md:text-[16px]',
              isActive
